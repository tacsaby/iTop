...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Core:AttributeTagSet' => 'Cédulák listája',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Change:FourOrMoreAttributesChanged' => '%1$s, %2$s és %3$s szerkesztve',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:EventNotification/Attribute:action_id' => 'Felhasználónév',
	'Class:EventNotification/Attribute:action_id+' => '',
	'Class:EventNotification/Attribute:object_id' => 'Objektumnév',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:EventRestService+' => 'REST/JSON szolgáltatáshívás',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:EventLoginUsage/Attribute:contact_email' => 'Kapcsolattartó e-mail cím',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:ActionEmail/Attribute:from_label' => 'Feladó név',
	...
	'Class:ActionEmail/Attribute:reply_to_label' => 'Válaszadó név',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:Trigger/Attribute:action_list' => 'Műveletek',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnStateChange' => 'Trigger (állapot változáskor)',
	'Class:TriggerOnStateChange+' => '',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnStateEnter' => 'Trigger (állapotba belépéskor)',
	'Class:TriggerOnStateEnter+' => '',
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnStateLeave' => 'Trigger (állapot elhagyáskor)',
	'Class:TriggerOnStateLeave+' => '',
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnObjectCreate' => 'Trigger (objektum létrehozáskor)',
	'Class:TriggerOnObjectCreate+' => '',
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnObjectDelete' => 'Trigger (objektum törléskor)',
	'Class:TriggerOnObjectDelete+' => ''
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnObjectUpdate' => 'Trigger (objektum törléskor)',
	'Class:TriggerOnObjectUpdate+' => '',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:lnkTriggerAction/Attribute:action_name' => 'Intézkedés név',
	'Class:lnkTriggerAction/Attribute:action_name+' => '',
	'Class:lnkTriggerAction/Attribute:trigger_id' => 'Trigger',
	'Class:lnkTriggerAction/Attribute:trigger_id+' => '',
	'Class:lnkTriggerAction/Attribute:trigger_name' => 'Trigger név',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:SynchroDataSource/Attribute:notify_contact_id' => 'Kapcsolattartó',
	...
	'Class:SynchroDataSource/Attribute:full_load_periodicity' => 'Teljes feltöltés intervallum',
	...
	'Core:SynchroAtt:reconciliation' => 'Egyeztetett?',
	...
	'Core:BulkExport:DragAndDropHelp' => 'Húzza az oszlopok fejléceit az oszlopok elrendezéséhez. %1$s sorok előnézete. Az exportálás sorainak száma: %2$s.',
	...
	'Core:BulkExport:OptionNoLocalize' => 'Kód exportálása cím helyett',
	...
	'Core:DateTime:Placeholder_H' => 'óó', // Hour 00..23
	'Core:DateTime:Placeholder_h' => 'ó', // Hour 01..12
	'Core:DateTime:Placeholder_G' => 'óó', // Hour 0..23
	'Core:DateTime:Placeholder_g' => 'ó', // Hour 1..12
	'Core:DateTime:Placeholder_a' => 'am/pm~~', // am/pm (lowercase)
	'Core:DateTime:Placeholder_A' => 'AM/PM~~', // AM/PM (uppercase)
	'Core:DateTime:Placeholder_i' => 'pp', // minutes, 2 digits: 00..59
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:TagSetFieldData/Attribute:label' => 'Cím',
	...
	'Class:TagSetFieldData/Attribute:finalclass' => 'Cédula osztály',
	'Class:TagSetFieldData/Attribute:obj_class' => 'Objektum osztály',
	'Class:TagSetFieldData/Attribute:obj_attcode' => 'Mezőkód',

	'Core:TagSetFieldData:ErrorDeleteUsedTag' => 'A felhasznált cédulák nem törölhetők',
	'Core:TagSetFieldData:ErrorDuplicateTagCodeOrLabel' => 'A céduláknak, kódoknak, feliratoknak egyedinek kell lennie',
	'Core:TagSetFieldData:ErrorTagCodeSyntax' => 'A cédulakódoknak 3 és %1$d közé eső alfanumerikus karaktereket kell tartalmaznia',
	'Core:TagSetFieldData:ErrorTagCodeReservedWord' => 'A választott cédulakód foglalt szót tartalmaz',
	'Core:TagSetFieldData:ErrorTagLabelSyntax' => 'A cédulafelirat nem tartalmazhat \'%1$s\' és üres sem lehet',
	'Core:TagSetFieldData:ErrorCodeUpdateNotAllowed' => 'A cédulakód nem változtatható ha használatban van',
	'Core:TagSetFieldData:ErrorClassUpdateNotAllowed' => 'A cédulák "objektum osztálya" nem változtatható',
	'Core:TagSetFieldData:ErrorAttCodeUpdateNotAllowed' => 'A cédulák "attribútum kódja" nem változtatható',
	'Core:TagSetFieldData:WhereIsThisTagTab' => 'Cédulahasználat (%1$d)',
	'Core:TagSetFieldData:NoEntryFound' => 'Nincs bejegyzés ehhez a cédulához',
));
