...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Core:AttributeObsolescenceFlag/Value:yes+' => 'Ez az objektum ki van zárva a hatásanalízisből és a keresésből',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:EventNotificationEmail/Attribute:attachments' => 'Csatolmány',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Action:WarningNoTriggerLinked' => 'Figyelmeztetés, nincs a művelethez kapcsolódó kiváltó ok. Addig nem lesz aktív, amíg legalább 1 nem lesz.',
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:Trigger/Attribute:context' => 'Contextus',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnPortalUpdate' => 'Kiváltó ok (amikor a portálról frissül)',
	'Class:TriggerOnPortalUpdate+' => 'Kiváltó ok egy végfelhasználó frissítésénél a portálon',
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnObjectDelete' => 'Kiváltó ok (objektum törlése)',
	'Class:TriggerOnObjectDelete+' => ''
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnObjectUpdate' => 'Kiváltó ok (objektum törlése)',
	'Class:TriggerOnObjectUpdate+' => '',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnObjectMention' => 'Kiváltó ok (objektumra hivatkozáskor)',
	'Class:TriggerOnObjectMention+' => '',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	'Class:TriggerOnThresholdReached' => 'Kiváltó ok (küszöbértéknél)',
	'Class:TriggerOnThresholdReached+' => '',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:SynchroDataSource/Attribute:action_on_zero' => 'Akció nulla esetén',
	'Class:SynchroDataSource/Attribute:action_on_zero+' => '',
	'Class:SynchroDataSource/Attribute:action_on_one' => 'Akció egy esetén',
	'Class:SynchroDataSource/Attribute:action_on_one+' => '',
	'Class:SynchroDataSource/Attribute:action_on_multiple' => 'Akció több esetén',
	...
	'Core:BulkExport:CSVLocalization' => 'Localizáció',
