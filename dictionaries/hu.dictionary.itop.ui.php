...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:AuditRule/Attribute:description' => 'Szabály leírása',
	'Class:AuditRule/Attribute:description+' => '',
	'Class:TagSetFieldData/Attribute:finalclass' => 'Cédulaosztály',
	...
	'Class:AuditRule/Attribute:category_name' => 'Kategória név',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:User/Error:AtLeastOneOrganizationIsNeeded' => 'A felhasználóhoz legalább egy szervezetet hozzá kell rendelni',
	'Class:User/Error:OrganizationNotAllowed' => 'A szervezet nem engedélyezett.',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:URP_ActionGrant/Attribute:action' => 'Intézkedés',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:URP_AttributeGrant+' => '',
	'Class:URP_AttributeGrant/Attribute:actiongrantid' => 'Intézkedés engedély',
...
<li>Műsszerfalak az IT infrastruktúra pillanatnyi állapotának gyors áttekintésére.</li>
</ul>
...
<div>Szabja testre az '.ITOP_APPLICATION.' beállításait a kényelmesebb használathoz.</div>',
	...
	'UI:Menu:OtherTransitions' => 'Más átmenetek',
	'UI:Menu:New' => 'Új...',
	...
	'UI:ResetPwd-Error-NoEmail' => 'hiányzik az e-mail cím. Keresse a rendszergazdát.',
	'UI:ResetPwd-Error-Send' => 'e-mail továbbítási hiba. Keresse a rendszergazdát',
	'UI:ResetPwd-EmailSent' => 'Kérjük, ellenőrizze az e-mail postafiókját, és kövesse az utasításokat. Ha nem kap e-mailt, kérjük, ellenőrizze a beírt bejelentkezési adatait.',
	...
	'UI:ResetPwd-Error-InvalidToken' => 'Sajnáljuk, de vagy már visszaállították a jelszót, vagy már több e-mailt is kapott. Kérjük, mindenképpen használja a legutolsó kapott e-mailben megadott linket.',
	...
	'UI:Login:Error:WrongOrganizationName'         => 'Ismeretlen szervezet',
	'UI:Login:Error:MultipleContactsHaveSameEmail' => 'Több kapcsolattartónál ugyanez az e-mailcím',
	...
	'UI:Audit:Dashboard:ObjectsAudited' => 'Objektumok auditálva',
	'UI:Audit:Dashboard:ObjectsInError' => 'Objektumok hibásan',
	'UI:Audit:Dashboard:ObjectsValidated' => 'Objektumok érvényesítve',
	...
	'UI:RunQuery:ResultSQLCount' => 'Létrejött SQL a számításhoz',
	...
	'UI:Schema:DisplayLabel' => 'Kijelzés:',
	'UI:Schema:DisplaySelector/LabelAndCode' => 'Felirat és kód',
	'UI:Schema:DisplaySelector/Label' => 'Felirat',
	...
	'UI:Search:NeedleTooShort' => 'A \\"%1$s\\" kereső sztring túl rövid. Legalább %2$d karaktert írjon be.',
	...
	'UI:UserManagement:Action' => 'Intézkedés',
	'UI:UserManagement:Action+' => '',
	'UI:UserManagement:TitleActions' => 'Intézkedések',
	'UI:UserManagement:Permission' => 'Jogosutlság',
	...
	'UI-ConfigurationManagementMenu-InfraByType' => 'Infrastruktúra objektumok típusok szerint',
	'UI-ConfigurationManagementMenu-InfraByStatus' => 'Infrastruktúra objektumok státuszok szerint',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Az '.ITOP_APPLICATION_SHORT.' alkalmazásban az értesítések teljesen testreszabhatók. Értesítések az objektumok két csoportjára épülnek: <i>triggerek és intézkedések</i>.</p>
<p><i><b>A triggerek</b></i> meghatározzák, hogy mikor kerüljön végrehajtásra az értesítés. Az iTop magjának részei a különböző triggerek, de a bővítményekkel továbbiak is létrehozhatók:
<ol>
	<li>Egyes triggerek akkor hajtódnak végre, amikor a megadott osztály egy objektuma <b>létrehozva</b>, <b>frissítve</b> vagy <b>törölve</b> állapotú.</li>
	<li>Egyes triggerek akkor hajtódnak végre, amikor a megadott osztály egy objektuma <b>belép</b> vagy <b>elhagy</b> egy meghatározott </b>állapotot</b>.</li>
	<li>Egyes triggerek akkor hajtódnak végre, amikor egy <b>TTO vagy TTR küszöbérték</b><b>el lett érve</b>.</li>
</ol>
</p>
<p>
...
<ol>
	...
	<li>Kimenő webhook-ok: Lehetővé teszik a harmadik fél alkalmazásával való integrációt strukturált adatok küldésével egy meghatározott URL-címre.</li>
</ol>
</p>
<p>Művelet végrehjatásához azt egy triggerhez kell rendelni.
Művelet triggerhez rendelésekor kap egy sorszámot , amely meghatározza a műveletek végrehajtási sorrendjét.</p>',
	'UI:NotificationsMenu:Triggers' => 'Triggerek',
	'UI:NotificationsMenu:AvailableTriggers' => 'Lehetséges triggerek',
	'UI:NotificationsMenu:OnCreate' => 'Objektum létrehozás',
	'UI:NotificationsMenu:OnStateEnter' => 'Objketum állapotba való belépése',
	'UI:NotificationsMenu:OnStateLeave' => 'Objektum állapotból való kilépése',
	...
	'UI:NotificationsMenu:AvailableActions' => 'Lehetséges műveletek',

	'Menu:TagAdminMenu' => 'Cédulák konfigurációja',
	'Menu:TagAdminMenu+' => 'Cédula érték kezelés',
	'UI:TagAdminMenu:Title' => 'Cédula konfiguráció',
	...
	'UI:DeadlineMissedBy_duration' => 'Elmulasztva %1$s által',
	'UI:Deadline_LessThan1Min' => '< 1 perc',
	'UI:Deadline_Minutes' => '%1$d perc',
	'UI:Deadline_Hours_Minutes' => '%1$d óra %2$d perc',
	'UI:Deadline_Days_Hours_Minutes' => '%1$n ap %2$d óra %3$d perc',
	'UI:Help' => 'Súgó',
	...
	'Portal:NoRequestMgmt' => 'Kedves %1$s, Önt erre az oldalra irányítottuk át, mert fiókjában a \'Portál felhasználó\' profil van beállítva. Sajnos a '.ITOP_APPLICATION_SHORT.' nem lett telepítve a \'Kérelemkezelés\' funkcióval. Kérjük, lépjen kapcsolatba a rendszergazdával.',
	'Portal:Refresh' => 'Frissítés',
	'Portal:Back' => 'Vissza',
	'Portal:WelcomeUserOrg' => 'Üdvözöljük %1$s, a %2$s -ból',
	'Portal:TitleDetailsFor_Request' => 'Kérelem részletei',
	'Portal:ShowOngoing' => 'Nyitott kérelmek mutatása',
	'Portal:ShowClosed' => 'Lezárt kérelmek mutatása',
	...
	'UI:ArchiveModeOn' => 'Archív mód bekapcsolása',
	'UI:ArchiveModeOff' => 'Archív mód kikapcsolása',
	...
	'UI:Button:MoveUp' => 'Mozgasd fel',
	'UI:Button:MoveDown' => 'Mozgasd le',
	...
	'UI:ImportDashboardText' => 'Importáláshoz válasszon ki egy vezérlőpult fájlt:',
	...
	'UI:DashletObjectList:Label' => 'Objektum lista',
	'UI:DashletObjectList:Description' => 'Objektum lista műszer',
	...
	'UI:DashletHeaderDynamic:Prop-Subtitle' => 'Alfelirat',
	...
	'UI:ShortcutDelete:Confirm' => 'Hagyja jóvá a parancsikon(ok) törlését.',
	...
	'Class:ShortcutOQL' => 'Keresési eredmények parancsikonja',
	'Class:ShortcutOQL+' => '',
	...
	'UI:CSVImport:DateAndTimeFormats' => 'Dátum és idő formátum',
...
<tr><td>s</td><td>seconds (2 számjegy, pl. 00..59)</td></tr>
	...
	'portal:backoffice' => ITOP_APPLICATION_SHORT.' Adminisztrációs felhasználói felület',
	...
	'UI:Search:NoAutoSubmit:ExplainText' => 'Adjon meg néhány kritériumot a keresőmezőben, vagy kattintson a keresés gombra az objektumok megtekintéséhez.',
	'UI:Search:Criterion:MoreMenu:AddCriteria' => 'Adjon meg egy kritériumot',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Menu:AdminTools+' => '',
	'Menu:AdminTools?' => 'Az eszközök csak az adminisztrátori profilhoz rendlet felhasználók számára elérhetők.',
	...
	'Menu:RunQueriesMenu+'        => '',
	'Menu:QueryMenu'              => 'Lekérdezés kifejezésgyűjtemény',
	'Menu:QueryMenu+'             => 'Lekérdezés kifejezésgyűjtemény',
	...
	'Menu:UserAccountsMenu+'      => '',
	'Menu:UserAccountsMenu:Title' => 'Felhasználói fiókok',
	'Menu:MyShortcuts'            => 'Saját parancsikonok',
