...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:AuditCategory/Attribute:description' => 'Audit kategória leírás',
	'Class:AuditCategory/Attribute:description+' => '',
	'Class:AuditCategory/Attribute:definition_set' => 'Definíciókészet',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:Query/Attribute:is_template' => 'OQL mező sablon',
	...
	'Class:QueryOQL/Attribute:fields+' => 'Az exportálandó attribútumok (vagy alias.attribútum) vesszővel elválasztott listája',
	'Class:QueryOQL' => 'OQL lekérdezés',
	'Class:QueryOQL+' => 'Object Query Language nyelven alapuló lekérdezés',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:User/Attribute:org_id+' => 'A társult személy szervezeti egysége',
	'Class:User/Attribute:last_name' => 'Keresztnév',
	'Class:User/Attribute:last_name+' => '',
	'Class:User/Attribute:first_name' => 'Családnév',
	'Class:User/Attribute:first_name+' => '',
	'Class:User/Attribute:email' => 'E-mail cím',
	...
	'Class:User/Attribute:status' => 'Státusz',
	...
	'Class:User/Error:ProfileNotAllowed' => 'A "%1$s" profil nem adható hozzá, megtagadja a backoffice-hozzáférést.',
	'Class:User/Error:StatusChangeIsNotAllowed' => 'A státusz megváltoztatása nem engedélyezett a saját felhasználó számára.',
	...
	'Class:User/Error:AtLeastOneOrganizationIsNeeded' => 'Legalább egy szervezetet hozzá kell rendelni ehhez a felhasználóhoz.',
	'Class:User/Error:OrganizationNotAllowed' => 'Nem engedélyezett szervezet.',
	'Class:User/Error:UserOrganizationNotAllowed' => 'A felhasználói fiók nem tartozik az engedélyezett szervezetekhez.',
	'Class:User/Error:PersonIsMandatory' => 'A kapcsolattartó megadása kötelező',
	'Class:UserInternal' => 'Belső felhasználó',
	'Class:UserInternal+' => 'Felhasználó, amely '.ITOP_APPLICATION_SHORT.'-on belül lett létrehozva',
));
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:URP_Profiles+' => '',
	'Class:URP_Profiles/Attribute:name' => 'Név',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:URP_Dimensions+' => '',
	'Class:URP_Dimensions/Attribute:name' => 'Név',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:URP_UserProfile/Attribute:reason' => 'Indok',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:URP_UserOrg/Attribute:reason' => 'Indok',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Class:UserDashboard/Attribute:contents' => 'Tartalomjegyzék',
...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'Menu:WelcomeMenu' => 'Kezdőlap',// Duplicated into itop-welcome-itil (will be removed from here...)
...
<li>Incidenskezelés modul az összes IT-hez kapcsolódó kérés életciklusának követésére.</li>
<li>Változáskezelés modul az IT infrastruktúra változásainak nyomonkövetésére és tervezésére.</li>
<li>Ismert hibák adatbázisa az incidenskezelés sebességének növelésére.</li>
...
<li>hatékonyan tudja kezelni az egyik legfontosabb IT eszközt, a dokumentációt.</li>
	...
	'UI:WelcomeMenu:Text'=> '<div>Gratulálunk, megérkezett az '.ITOP_APPLICATION.' '.ITOP_VERSION_NAME.' oldalára!</div>

<div>Ez a verzió vadonatúj, modern és könnyen hozzáférhető backoffice dizájnnal rendelkezik.</div>

<div>Megtartottuk az '.ITOP_APPLICATION.' alapvető funkcióit és modernizáltuk őket, hogy megkedveltessük önnel.
Reméljük, hogy ezt a verziót ugyanúgy kedvelni fogja, mint ahogy mi élveztük az elképzelését és létrehozását.</div>

<div>Szabja testre az '.ITOP_APPLICATION.' beállításait a személyre szabott élmény érdekében.</div>',
	...
	'UI:Button:Insert' => 'Beszúrás',
	'UI:Button:More' => 'Több',
	'UI:Button:Less' => 'Kevesebb',
	'UI:Button:Wait' => 'Várjon amíg a mezők frissülnek',
	'UI:Treeview:CollapseAll' => 'Összecsukás',
	'UI:Treeview:ExpandAll' => 'Kinyitás',
	'UI:UserPref:DoNotShowAgain' => 'Ne mutassa újra',
	'UI:InputFile:NoFileSelected' => 'Nincs fájl kijelölve',
	'UI:InputFile:SelectFile' => 'Fájl kijelölése',
	...
	'UI:Error:SaveFailed' => 'Az objektum nem menthető : ',
	...
	'UI:Error:ReadNotAllowedOn_Class' => 'A(z) %1$s osztályú objektumokat nem tekintheti meg',
	...
	'UI:Error:SMTP:UnknownVendor' => 'OAuth SMTP szolgáltató %1$s nem létezik (email_transport_smtp.oauth.provider)',
	...
	'UI:History:BulkImports' => 'Előzmény',
	...
	'UI:Menu:Transitions' => 'Átmenetek',
	'UI:Menu:OtherTransitions' => 'Egyéb átmenetek',
	'UI:Menu:New' => 'Új...',
	'UI:Menu:Add' => 'Hozzáad...',
	...
	'UI:SearchValue:NbSelected' => '# kiválasztott',
	'UI:SearchValue:CheckAll' => 'Összes bejelölése',
	'UI:SearchValue:UncheckAll' => 'Bejelölések törlése',
	...
	'UI:Login:ForgotPwdForm+' => ITOP_APPLICATION_SHORT.' küldhet Önnek egy e-mailt, amelyben utasításokat talál a fiókja visszaállításához.',
	'UI:Login:ResetPassword' => 'Küldje most!',
	'UI:Login:ResetPwdFailed' => 'Sikertelen e-mail küldés: %1$s',
	'UI:Login:SeparatorOr' => 'Vagy',

	'UI:ResetPwd-Error-WrongLogin' => '\'%1$s\' nem érvényes a felhasználónév',
	'UI:ResetPwd-Error-NotPossible' => 'a külső felhasználó nem változtathatja itt a jelszavát.',
	'UI:ResetPwd-Error-FixedPwd' => 'a fiókon nem engedélyezett a jelszó változtatás.',
	'UI:ResetPwd-Error-NoContact' => 'a fiók nem egy valós személyhez tartozik.',
	'UI:ResetPwd-Error-NoEmailAtt' => 'a fiók nem kapcsolódik olyan személyhez, aki rendelkezik e-mail attribútummal. Lépjen kapcsolatba a rendszergazdával.',
	'UI:ResetPwd-Error-NoEmail' => 'hiányzik egy e-mail cím. Lépjen kapcsolatba a rendszergazdával.',
	'UI:ResetPwd-Error-Send' => 'e-mail továbbítási technikai probléma. Lépjen kapcsolatba a rendszergazdával.',
	'UI:ResetPwd-EmailSent' => 'Ellenőrizze az e-mail postafiókját, és kövesse az utasításokat. Ha nem kap e-mailt, kérjük, ellenőrizze a beírt bejelentkezési adatokat.',
	'UI:ResetPwd-EmailSubject' => 'Állítsa vissza az '.ITOP_APPLICATION_SHORT.' jelszavát',
	'UI:ResetPwd-EmailBody' => '<body><p>Ön kérte az '.ITOP_APPLICATION_SHORT.' jelszava visszaállítását.</p><p>Kövesse ezt a linket (egyszeri használat) az <a href="%1$s">új jelszó megadásához</a></p>.',

	'UI:ResetPwd-Title' => 'Jelszó visszaállítása',
	'UI:ResetPwd-Error-InvalidToken' => 'Sajnáljuk, de vagy már visszaállították a jelszót, vagy már több e-mailt is kapott. Mindenképpen a legutolsó kapott e-mailben megadott linket használja.',
	'UI:ResetPwd-Error-EnterPassword' => 'Adja meg a \'%1$s\' fiók jelszavát.',
	...
	'UI:Login:Error:MultipleContactsHaveSameEmail' => 'Több kapcsolattartónak is ugyanaz az e-mail címe',
	'UI:Login:Error:NoValidProfiles'               => 'Nincs érvényes profil megadva',
	...
	'UI:Title:CSVImportStep3' => '3. lépés az 5-ből: Adatok összerendelése',
	...
	'UI:CSVImport:TextQualifierCharacter' => 'Szövegminősítő karakter',
	...
	'UI:CSVImport:AlertIncompleteMapping' => 'Adja meg az összes mezőre az összerendelési szabályokat.',
	'UI:CSVImport:AlertMultipleMapping' => 'Ügyeljen arra, hogy egy célmezőt csak egyszer rendeljen össze.',
	'UI:CSVImport:AlertNoSearchCriteria' => 'Adjon meg legalább egy keresési kritériumot',
	...
	'UI:CSVReport-Value-SetIssue' => 'Érvénytelen attribútum érték',
	'UI:CSVReport-Value-ChangeIssue' => '\'%1$s\' értéke érvénytelen',
	'UI:CSVReport-Value-NoMatch' => 'Nem egyezik a \'%1$s\' értékkel',
	'UI:CSVReport-Value-Missing' => 'Hiányzó kötelező érték',
	'UI:CSVReport-Value-Ambiguous' => 'Többértelműség: %1$s objektumban',
	'UI:CSVReport-Row-Unchanged' => 'változatlan',
	'UI:CSVReport-Row-Created' => 'létrehozva',
	'UI:CSVReport-Row-Updated' => 'frissítve %1$d oszlop',
	'UI:CSVReport-Row-Disappeared' => 'eltűnt, megváltozott %1$d oszlop',
	'UI:CSVReport-Row-Issue' => 'Probléma: %1$s',
	'UI:CSVReport-Value-Issue-Null' => 'A nulla nem engedélyezett',
	'UI:CSVReport-Value-Issue-NotFound' => 'Nincs meg az objektum',
	'UI:CSVReport-Value-Issue-FoundMany' => '%1$d egyezés található',
	'UI:CSVReport-Value-Issue-Readonly' => 'A \'%1$s\' attribútum csak olvasható és nem módosítható (jelenlegi érték: %2$s, javasolt érték: %3$s).',
	'UI:CSVReport-Value-Issue-Format' => 'A bemenet feldolgozása sikertelen: %1$s',
	'UI:CSVReport-Value-Issue-NoMatch' => 'Váratlan érték az \'%1$s\' attribútumhoz: nem találtunk egyezést, ellenőrizze a helyesírást.',
	'UI:CSVReport-Value-Issue-Unknown' => 'Váratlan érték az \'%1$s\' attribútumhoz: %2$s',
	'UI:CSVReport-Row-Issue-Inconsistent' => 'Az attribútumok nem állnak összhangban egymással: %1$s',
	'UI:CSVReport-Row-Issue-Attribute' => 'Nem várt attribútumérték(ek)',
	'UI:CSVReport-Row-Issue-MissingExtKey' => 'Nem sikerült létrehozni a hiányzó külső kulcs(ok) miatt: %1$s',
	'UI:CSVReport-Row-Issue-DateFormat' => 'hibás dátumformátum',
	'UI:CSVReport-Row-Issue-Reconciliation' => 'nem sikerült összeegyeztetni',
	'UI:CSVReport-Row-Issue-Ambiguous' => 'kétértelmű egyeztetés',
	...
	'UI:CSVReport-Object-ToCreate' => 'Létrehozandó objektum',
	'UI:CSVReport-Object-Created' => 'Objektum létrehozva',
	'UI:CSVReport-Icon-Error' => 'Hiba',
	'UI:CSVReport-Object-Error' => 'HIBA: %1$s',
	'UI:CSVReport-Object-Ambiguous' => 'KÉTÉRTELMŰ: %1$s',
	'UI:CSVReport-Stats-Errors' => '%1$.0f %% betöltött objektum hibás és figyelmen kívül lesz hagyva.',
	'UI:CSVReport-Stats-Created' => '%1$.0f %% betöltött objektum létre lesz hozva.',
	'UI:CSVReport-Stats-Modified' => '%1$.0f %% betöltött objektum módosítva lesz',

	'UI:CSVExport:AdvancedMode' => 'Haladó mód',
	'UI:CSVExport:AdvancedMode+' => 'Haladó módban az exportáláshoz több oszlopot is hozzáadunk: az objektum azonosítóját, a külső kulcsok azonosítóját és egyeztetési attribútumait.',
	'UI:CSVExport:LostChars' => 'Kódolási probléma',
	'UI:CSVExport:LostChars+' => 'A letöltött fájl %1$s -ba lesz kódolva. '.ITOP_APPLICATION_SHORT.' olyan karaktereket észlelt, amelyek nem kompatibilisek ezzel a formátummal. Ezeket a karaktereket vagy helyettesítő karakterekkel helyettesíti (pl. az ékezetes karakterek elveszítik az ékezetet), vagy elveti őket. Az adatokat a webböngészőből másolhatja/beillesztheti. Alternatív megoldásként a rendszergazdához fordulhat a kódolás megváltoztatásához (lásd a \'csv_file_default_charset\ paramétert.').',
	...
	'UI:Audit:Dashboard:ObjectsAudited' => 'Auditált objektumok',
	'UI:Audit:Dashboard:ObjectsInError' => 'Hibás objektumok',
	'UI:Audit:Dashboard:ObjectsValidated' => 'Érvényesített objektumok',
	'UI:Audit:AuditCategory:Subtitle' => '%1$s hiba a %2$s -ból - %3$s%%',


	'UI:RunQuery:Title' => ITOP_APPLICATION_SHORT.' - OQL lekérdezés értékelés',
	'UI:RunQuery:QueryExamples' => 'Lekérdezés példák',
	'UI:RunQuery:QueryResults' => 'Lekérdezés eredmények',
	...
	'UI:RunQuery:QueryArguments' => 'Argumentumok lekérdezése',
	...
	'UI:RunQuery:DevelopedOQL' => 'Továbbfejlesztett OQL',
	'UI:RunQuery:DevelopedOQLCount' => 'Továbbfejlesztett OQL a számoláshoz',
	'UI:RunQuery:ResultSQLCount' => 'A létrejött SQL a számoláshoz',
	'UI:RunQuery:ResultSQL' => 'Létrejött SQL',
	'UI:RunQuery:Error' => 'A lekérdezés futtatása közben a következő hiba jelentkezett',
	'UI:Query:UrlForExcel' => 'URL az MS-Excel web lekérdezéshez',
	'UI:Query:UrlV1' => 'A mezők listája nincs megadva. Az <em>export-V2.php</em> oldal ezen információk nélkül nem hívható meg. Ezért az itt javasolt URL a régi oldalra mutat: <em>export.php</em>. Az exportálás ezen örökölt verziójára a következő korlátozások vonatkoznak: az exportált mezők listája a kimeneti formátumtól és a ' adatmodelljétől függően változhat. ITOP_APPLICATION_SHORT." Ha garantálni szeretné, hogy az exportált oszlopok listája hosszú távon stabil marad, akkor meg kell adnia egy értéket a "Fields" attribútumhoz, és az <em>export-V2.php</em> oldalt kell használnia.',
	...
	'UI:Schema:DisplaySelector/LabelAndCode' => 'Címke és kód',
	'UI:Schema:DisplaySelector/Label' => 'Címke',
	'UI:Schema:DisplaySelector/Code' => 'Kód',
	'UI:Schema:Attribute/Filter' => 'Szűrő',
	'UI:Schema:DefaultNullValue' => 'Alapértelmezett null : "%1$s"',
	'UI:LinksWidget:Autocomplete+' => '',
	'UI:Edit:SearchQuery' => 'Előre beállított lekérdezés',
	'UI:Edit:TestQuery' => 'Lekérdezés teszt',
	...
	'UI:Error:ActionNotAllowed' => 'Nem engedélyezett ez a művelet',
	...
	'UI:ObjectArchived' => 'Ez az objektum archiválva lett. Kérjük, engedélyezze az archiválási módot, vagy lépjen kapcsolatba a rendszergazdával.',
	...
	'UI:Search:NeedleTooShort' => 'A \\"%1$s\\" kereső sztring túl rövid. Legaláb %2$d karaktert írjon be.',
	...
	'UI:FatalErrorMessage' => 'Végzetes hiba, '.ITOP_APPLICATION_SHORT.' nem tudja a működését folytatni',
	'UI:Error_Details' => 'Hiba: %1$s.',

	'UI:PageTitle:ProfileProjections' => ITOP_APPLICATION_SHORT.' felhasználó kezelés - profil nézet',
	...
	'UI:UserManagement:GrantMatrix' => 'Jogosutlság mátrix',
	...
	'UI-ConfigurationManagementMenu-InfraByType' => 'Infrastruktúra objektumok típus szerint',
	'UI-ConfigurationManagementMenu-InfraByStatus' => 'Infrastruktúra objektumok státusz szerint',
	...
	'UI-RequestManagementOverview-RequestUnassigned' => 'Felhasználói kérelmek, amelyek még nem lettek felelőshöz rendelve',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Az '.ITOP_APPLICATION_SHORT.' alkalmazásban az értesítések teljesen testreszabhatók. Értesítések az objektumok két csoportjára épülnek: <i>triggerek és műveletek</i>.</p>
<p><i><b>A triggerek</b></i> határozzák meg hogy egy értesítés mikor legyen elküldva. Az iTop rendszermag részét képezik különböző triggerek, de a többit a bővítményekkel is el lehet érni:
<ol>
	<li>Egyes triggerek akkor hajtódnak végre, amikor a megadott osztály egy objektuma <b>létrejött</b>, <b>frissült</b> vagy <b>kitörlődik</b>.</li>
	<li>Néhány trigger akkor hajtódik végre, ha egy adott osztály egy objektuma <b>belép</b> vagy <b>elhagy</b> egy bizonyos </b>állapotba</b>.</li>
	<li>Néhány trigger akkor hajtódik végre, amikor egy <b>TTO vagy TTR küszöbértéket</b><b>elér</b>.</li>
</ol>
</p>
<p>
<i><b>A műveletek</b></i> meghatározzák a triggerek végrehajtásakor végrehajtandó műveleteket. Egyelőre csak kétféle művelet létezik:
<ol>
	<li>E-mail üzenet küldése: Az ilyen műveletek meghatározzák az e-mail küldéséhez használandó sablont, valamint az üzenet egyéb paramétereit, mint például a címzettek, fontosság stb.<br />
	...
	<li>Kimenő webhook-ok: Lehetővé teszi a harmadik fél alkalmazásával való integrációt strukturált adatok küldésével egy meghatározott URL-címre.</li>
</ol>
</p>
<p>Művelet végrehjatásához azt egy triggerhez kell rendelni.
A művelet triggerhez rendelésekor kap egy sorszámot , amely meghatározza a műveletek végrehatási sorrendjét.</p>',
	'UI:NotificationsMenu:Triggers' => 'Triggerek',
	'UI:NotificationsMenu:AvailableTriggers' => 'Elérhető triggerek',
	'UI:NotificationsMenu:OnCreate' => 'Objektum létrehozáskor',
	'UI:NotificationsMenu:OnStateEnter' => 'Objketum állapotba való belépésekor',
	'UI:NotificationsMenu:OnStateLeave' => 'Objektum állotból való kilépésekor',
	'UI:NotificationsMenu:Actions' => 'Műveletek',
	'UI:NotificationsMenu:Actions:ActionEmail' => 'E-mail műveletek',
	'UI:NotificationsMenu:Actions:ActionWebhook' => 'Webhook műveletek (kimenő integráció)',
	'UI:NotificationsMenu:Actions:Action' => 'Egyéb műveletek',
	'UI:NotificationsMenu:AvailableActions' => 'Elérhető műveletek',

	'Menu:TagAdminMenu' => 'Cédulák configurációja',
	'Menu:TagAdminMenu+' => 'Cédulák értékeinek kezelése',
	'UI:TagAdminMenu:Title' => 'Cédulák konfigurációja',
	'UI:TagAdminMenu:NoTags' => 'Nincs cédula mező konfigurálva',
	...
	'Menu:QueryMenu' => 'Lekérdezés kifejezésgyűjtemény',// Duplicated into itop-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'Lekérdezés kifejezésgyűjtemény',// Duplicated into itop-welcome-itil (will be removed from here...)
	...
	'UI:Document:NoPreview' => 'Nincs előnézet ehhez a dokumentumhoz',
	'UI:Download-CSV' => 'Letöltés %1$s',
	...
	'UI:RelationGroupNumber_N' => 'Csoport #%1$d',
	...
	'UI:Relation:PDFExportOptions' => 'PDF exportálás beállítások',
	'UI:Relation:AttachmentExportOptions_Name' => '%1$s mellékletének beállításai',
	'UI:RelationOption:Untitled' => 'Névtelen',
	'UI:Relation:Key' => 'Kulcs',
	'UI:Relation:Comments' => 'Megjegyzés',
	'UI:RelationOption:Title' => 'Cím',
	'UI:RelationOption:IncludeList' => 'Tartalmazza az objektumok listáját',
	'UI:RelationOption:Comments' => 'Megjegyzés',
	...
	'UI:RelationTooltip:ImpactedItems_N_of_M' => '# az érintett elemek: %1$d / %2$d',
	...
	'Portal:NoRequestMgmt' => 'Tisztelt %1$s, azért lett átirányítva erre az oldalra, mert az Ön fiókjában a \'Portál felhasználó\' profil van beállítva. Sajnos a '.ITOP_APPLICATION_SHORT.' nem lett telepítve a \'Kérelemkezelés\' funkcióval. Lépjen kapcsolatba a rendszergazdával.',
	'Portal:Refresh' => 'Frissítés',
	'Portal:Back' => 'Vissza',
	'Portal:WelcomeUserOrg' => 'Üdvözöljük %1$s, from %2$s',
	...
	'Portal:CreateNewIncidentItil' => 'Új incidens jelentés létrehozása',
	...
	'Portal:PleaseSelectOneService' => 'Válasszon egy szolgáltatást',
	'Portal:SelectSubcategoryFrom_Service' => 'Válassza ki a %1$s szolgáltatás alkategóriáját:',
	'Portal:PleaseSelectAServiceSubCategory' => 'Válasszon egy alkategóriát',
	...
	'Portal:SelectRequestTemplate' => 'Sablon választása a %1$s -hoz',
	...
	'UI:Pagination:HeaderSelection' => 'Összesen: %1$s objects (%2$s objects selected).',
	'UI:Pagination:HeaderNoSelection' => 'Összesen: %1$s objects.~~',
	'UI:Pagination:PageSize' => '%1$s objektum oldalanként',
	'UI:Pagination:PagesLabel' => 'Oldal:',
	'UI:Pagination:All' => 'Mind',
	'UI:HierarchyOf_Class' => '%1$s hierarchiája',
	'UI:Preferences' => 'Beállítások...',
	'UI:ArchiveModeOn' => 'Archív módra váltás',
	'UI:ArchiveModeOff' => 'Kilépés az archív módból',
	'UI:ArchiveMode:Banner' => 'Archív mód',
	'UI:ArchiveMode:Banner+' => 'Az archivált objektumok láthatóak, és módosításuk nem engedélyezett.',
	'UI:FavoriteOrganizations' => 'Előnyben részesített szervezeti egységek',
	'UI:FavoriteOrganizations+' => 'Jelölje be az alábbi listában azokat a szervezeteket, amelyeket a gyors hozzáférés érdekében a legördülő menüben szeretne látni. Vegye figyelembe, hogy ez nem biztonsági beállítás, bármely szervezet objektumai továbbra is láthatóak és elérhetők a legördülő listában a \\"Minden szervezet\\" kiválasztásával.',
	...
	'UI:Favorites:Default_X_ItemsPerPage' => 'Alapértelmezett hosszúság:  %1$s elem oldalanként',
	...
	'UI:NavigateAwayConfirmationMessage' => 'Minden módosítás elveszik.',
	'UI:CancelConfirmationMessage' => 'Elveszíti a változtatásokat. Folytassa mégis?',
	...
	'UI:OrderByHint_Values' => 'Sorbarendezés: %1$s',
	...
	'UI:PrintResolution:FullSize' => 'Teljes méretű',
	...
	'UI:Toggle:SwitchToStandardDashboard' => 'Standard műszerfara váltás',
	'UI:Toggle:SwitchToCustomDashboard' => 'Egyéni műszerfalra váltás',
	...
	'UI:UseDefaultSettings' => 'Alapbeállítások használata',
	'UI:UseSpecificSettings' => 'Ezeknek a beállításoknak a használata:',
	...
	'UI:ForAllLists' => 'Alapértelmezetten minden listához',
	'UI:ExtKey_AsLink' => '%1$s (Link)',
	'UI:ExtKey_AsFriendlyName' => '%1$s (Rövid név)',
	'UI:ExtField_AsRemoteField' => '%1$s (%2$s)',
	'UI:Button:MoveUp' => 'Mozgatás fel',
	'UI:Button:MoveDown' => 'Mozgatás le',

	'UI:OQL:UnknownClassAndFix' => 'Ismeretlen osztály \\"%1$s\\". Próbálja \\"%2$s\\" -t helyette.',
	...
	'UI:ImportDashboardTitle' => 'Importálás fájlból',
	'UI:ImportDashboardText' => 'Válasszon egy műszerfal fájlt az importáláshoz:',
	...
	'UI:DashletCreation:DashletType' => 'Műszer típus',
	...
	'UI:DashboardEdit:AutoReloadSec' => 'Automatikus frissítés időköze (mp)',
	'UI:DashboardEdit:AutoReloadSec+' => 'A megengedett minimum %1$d mp',
	'UI:DashboardEdit:Revert' => 'Visszavonás',
	'UI:DashboardEdit:Apply' => 'Alkalmaz',

	'UI:DashboardEdit:Layout' => 'Elrendezés',
	'UI:DashboardEdit:Properties' => 'Műszerfal tulajdonságok',
	...
	'UI:DashletUnknown:Description' => 'Ismeretlen műszer (lehet hogy el lett távolítva)',
	'UI:DashletUnknown:RenderText:View' => 'Nem lehet megjeleníteni ezt a műszert.',
	'UI:DashletUnknown:RenderText:Edit' => 'Nem lehet megjeleníteni ezt a műszert ("%1$s" osztály). Ellenőrizze a rendszergazdánál, hogy még mindig elérhető-e.',
	'UI:DashletUnknown:RenderNoDataText:Edit' => 'Nincs előnézet ehhez a műszerhez ("%1$s" osztály).',
	'UI:DashletUnknown:Prop-XMLConfiguration' => 'Konfiguráció (nyers XML-ként látható)',

	'UI:DashletProxy:Label' => 'Proxy',
	'UI:DashletProxy:Description' => 'Proxy műszer',
	'UI:DashletProxy:RenderNoDataText:Edit' => 'Ehhez a harmadik féltől származó műszerhez nem áll rendelkezésre előnézet ("%1$s" osztály).',
	'UI:DashletProxy:Prop-XMLConfiguration' => 'Konfiguráció (nyers XML-ként látható)',
	...
	'UI:DashletPlainText:Prop-Text:Default' => 'Írjon ide valamilyen szöveget...',
	...
	'UI:DashletGroupBy:Prop-GroupBy:Hour' => 'Óra a %1$s -ból (0-23)',
	'UI:DashletGroupBy:Prop-GroupBy:Month' => 'Hónap a %1$s -ből (1 - 12)',
	'UI:DashletGroupBy:Prop-GroupBy:DayOfWeek' => 'Nap a %1$s hétből',
	'UI:DashletGroupBy:Prop-GroupBy:DayOfMonth' => 'Nap a %1$s hónapból',
	...
	'UI:DashletGroupBy:MissingGroupBy' => 'Kérjük, válassza ki azt a mezőt, amelyen az objektumok csoportosítva lesznek.',
	...
	// New in 2.5
	'UI:DashletGroupBy:Prop-Function' => 'Aggregálás funkció',
	'UI:DashletGroupBy:Prop-FunctionAttribute' => 'Funkció attribútuma',
	...
	'UI:Menu:ShortcutList' => 'Parancsikon létrehozása...',
	'UI:ShortcutRenameDlg:Title' => 'Parancsikon átnevezése',
	'UI:ShortcutListDlg:Title' => 'Parancsikon létrehozása a listához',
	'UI:ShortcutDelete:Confirm' => 'Kérjük, erősítse meg, hogy törölni kívánja a parancsikon(oka)t.',
	'Menu:MyShortcuts' => 'Saját parancsikonok',// Duplicated into itop-welcome-itil (will be removed from here...)
	'Class:Shortcut' => 'Parancsikon',
	'Class:Shortcut+' => '~~',
	'Class:Shortcut/Attribute:name' => 'Név',
	'Class:Shortcut/Attribute:name+' => 'Label used in the menu and page title~~',
	'Class:ShortcutOQL' => 'Keresési eredmény parancsikon',
	'Class:ShortcutOQL+' => '~~',
	...
	'Class:ShortcutOQL/Attribute:auto_reload/Value:custom' => 'Egyéni időköz',
	'Class:ShortcutOQL/Attribute:auto_reload_sec' => 'Automatikus frissítési időköz (mp)',
	'Class:ShortcutOQL/Attribute:auto_reload_sec/tip' => 'A megengedett minimum %1$d mp',
