...
Dict::Add('EN US', 'English', 'English', array(
	...
	'bkp-checks.phpext-phar-missing' => 'Missing PHP extension: phar',
	'bkp-checks.phpext-zlib-missing' => 'Missing PHP extension: zlib',
	'bkp-checks.exec-disabled' => 'The PHP exec() function has been disabled on this server',
	'bkp-checks.mysqldump-ok' => 'mysqldump is present: %1$s',
	'bkp-checks.mysqldump-notfound' => 'mysqldump could not be found: %1$s - Please make sure it is installed and in the path, or edit the configuration file to tune mysql_bindir.',
	'bkp-checks.mysqldump-issue' => 'mysqldump could not be executed (retcode=%1$d): Please make sure it is installed and in the path, or edit the configuration file to tune mysql_bindir',
	'bkp-checks.missing-dir' => 'The target directory <code>%1$s</code> could not be found',
	'bkp-checks.dir-not-writeable' => '%1$s is not writeable',
	'bkp-checks.free-disk-space' => '<b>%1$s free</b> in <code>%2$s</code>',
